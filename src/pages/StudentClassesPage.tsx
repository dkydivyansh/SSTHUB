          ...
          {classes.map((cls) => (
            ...
            >
              <div className="flex flex-col flex-1">
                <h3 className="font-black uppercase tracking-tighter text-2xl line-clamp-2 group-hover:text-purple-600 transition-colors">
                  {cls.name}
                </h3>
                {cls.description && (
              ...
              <div className="mt-4 pt-4 border-t-4 border-black flex justify-between items-center">
                <span className="font-black text-xs uppercase tracking-widest text-purple-600">Enrolled</span>
            ...
            {inviteLoading ? (
              ...
              <div className="flex flex-col">
                <div className="bg-[#FFF5E1] p-8 border-b-4 border-black flex flex-col items-center text-center relative overflow-hidden">
                  ...
                  <div className="flex flex-col">
                    <h3 className="font-black uppercase tracking-tighter text-3xl line-clamp-2">
                      {inviteData.name}
                    </h3>
                  </div>
                  <span className="font-bold uppercase tracking-widest text-xs bg-purple-100 text-purple-800 px-3 py-1 border-2 border-purple-800 mt-4">
                    Class Invitation
                  </span>
                </div>
